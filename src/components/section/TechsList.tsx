...
export const TechsList = ({ techs }: TechListProps) => {
  ...
  return (
    <>
      ...
      {techs.length > 0 ? (
        <ul className="grid max-h-80 w-full gap-4 overflow-hidden overflow-y-auto rounded-md border border-primary-violet6 bg-gradient-to-bl from-primary-violet2 to-primary-violet3 p-5 sm:grid-cols-1 lg:grid-cols-2 xl:max-h-96">
          {techs.map((tech) => (
